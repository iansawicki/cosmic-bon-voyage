"""
Voyage-embed artists_ai rows (combined_tags -> embedding).

Prefer: python embed_pipeline.py embed-artists
"""
...
def main() -> None:
    p = argparse.ArgumentParser(description="Voyage embeddings for artists_ai.")
